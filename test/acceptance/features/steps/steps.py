...
def given_serverless_operator_is_running(context):
    ...
    if not serverless_operator.is_running():
        ...
        serverless_operator.install_operator_subscription("redhat-operators", "techpreview") | should.be_truthy.desc(
...
@given('ubi-quarkus-native-s2i builder image is present')
def given_ubi_quarkus_builder_image_is_present():
    pass
